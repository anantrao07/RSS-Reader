...
public class ArticleDetailFragment extends Fragment implements
    ...
    private static final float PARALLAX_FACTOR = 2.4f;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       mDrawInsetsFrameLayout.setOnInsetsCallback(new DrawInsetsFrameLayout.OnInsetsCallback() {
        ...
        share_fab_btn.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
      ...
      share_fab_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    share_fab_btn.setElevation(12.0f);
                }
